...
Or maybe it's been a slow frog boil.
...
Profiling also tells me that there's a long GC pause -- perhaps this has to do with all the stuff created by a non-compiled generator that is being cleaned up. ("munge" might remove things as it adds? Would that help?
...
all_names on this node for not graph gives: 

list(arg = c("cont", "..."), call = c("list", "trace", "on.exit", 
"tryCatch", "cont", "stop_"), tail = "stop_", utility = "trace", 
    var = c("cont", "..."))
