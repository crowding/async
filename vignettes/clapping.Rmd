...
by one step. Over over the course of the piece, the two parts move out
and back into in phase with each other. We can write a generator
function that does this "skip," by consuming a value without yielding
it:
...
Now we should be able to give a performance
...
precise timing, so you may hear some glitches and pauses. Nevertheless,
